	...
	return (
		<DayPicker
			...
			classNames={{
				...
				day_selected:
					"bg-stone-900 text-white hover:bg-stone-900 hover:text-white focus:bg-stone-900 focus:text-white dark:bg-stone-50 dark:text-stone-900 dark:hover:bg-stone-50 dark:hover:text-stone-900 dark:focus:bg-stone-50 dark:focus:text-stone-900",
				day_outside:
					"day-outside text-stone-300 aria-selected:bg-stone-100/50 aria-selected:text-stone-500 dark:text-stone-400 dark:aria-selected:bg-stone-800/50 dark:aria-selected:text-stone-400",
